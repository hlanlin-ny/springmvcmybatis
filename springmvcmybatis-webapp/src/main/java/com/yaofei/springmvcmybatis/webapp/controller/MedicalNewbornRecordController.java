 ...
 */
@Controller
@RequestMapping("/admin/medicalnewbornrecord")
public class MedicalNewbornRecordController extends BaseCRUDController<MedicalNewbornRecord>  {
	@Autowired
	...
	public JsonResult updatetocommon(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		List<MedicalNewbornRecord> list = medicalNewbornRecordService.queryListAll();
