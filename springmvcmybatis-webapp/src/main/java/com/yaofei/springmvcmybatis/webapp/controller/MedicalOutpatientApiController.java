...
import com.yaofei.springmvcmybatis.service.MedicalOutpatientRecordApiService;
 ...
 */
@Controller
@RequestMapping("/admin/api/medicalOutpatientApi")
public class MedicalOutpatientApiController {
