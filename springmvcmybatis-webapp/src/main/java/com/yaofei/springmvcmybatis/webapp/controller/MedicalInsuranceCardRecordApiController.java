...
import com.yaofei.springmvcmybatis.service.MedicalInsuranceCardRecordApiService;
 ...
 */
@Controller
@RequestMapping("/admin/api/medicalInsuranceCardApi")
public class MedicalInsuranceCardRecordApiController {
