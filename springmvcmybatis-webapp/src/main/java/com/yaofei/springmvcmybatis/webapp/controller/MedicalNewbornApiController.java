...
import com.yaofei.springmvcmybatis.service.MedicalNewbornRecordApiService;
 ...
 */
@Controller
@RequestMapping("/admin/api/medicalNewbornApi")
public class MedicalNewbornApiController {
