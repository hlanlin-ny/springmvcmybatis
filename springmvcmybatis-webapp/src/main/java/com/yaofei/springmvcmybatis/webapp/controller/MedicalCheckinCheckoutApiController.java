...
import com.yaofei.springmvcmybatis.service.MedicalCheckinCheckoutRecordApiService;
 ...
 */
@Controller
@RequestMapping("/admin/api/medicalCheckinCheckoutApi")
public class MedicalCheckinCheckoutApiController {
