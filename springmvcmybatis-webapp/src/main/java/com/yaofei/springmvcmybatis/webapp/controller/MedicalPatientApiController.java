...
import com.yaofei.springmvcmybatis.service.MedicalPatientRecordApiService;
 ...
 */
@Controller
@RequestMapping("/admin/api/medicalPatientApi")
public class MedicalPatientApiController {
...
//    }
    ...
    public JsonResult add(@RequestHeader("u") String username, @RequestHeader("s") String sign, @RequestHeader("n") Integer nonce, @RequestHeader("t") String timestamp, @RequestHeader("e") String extension, @Valid @RequestBody MedicalPatientRecord medicalPatientRecord, BindingResult result, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        medicalPatientRecordApiService.add(username, sign, nonce, medicalPatientRecord, request);
        return JsonResult.ok();
    }
