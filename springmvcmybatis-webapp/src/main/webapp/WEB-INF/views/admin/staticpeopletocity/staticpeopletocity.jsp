...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            <shiro:hasPermission name="staticpeopletocity:search">
                <!-- form start -->
                <form id="query-form" class="form-horizontal">
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="extra-search-zyzgmc" class="col-sm-2 control-label">职业资格名称</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="extra-search-zyzgmc"
                                           name="extra-search-zyzgmc" placeholder="职业资格名称"/>
                                </div>
                            ...
                            <div class="form-group">
                                <label for="extra-search-hjdzDzmc" class="col-sm-2 control-label">户籍地址名称</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="extra-search-hjdzDzmc"
                                           name="extra-search-hjdzDzmc" placeholder="户籍地址名称"/>
                                </div>
                            </div>
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <shiro:hasPermission name="staticpeopletocity:refersh">
                            <button id="btn-refresh" type="button" class="btn btn-default">
                                <i class="fa fa-refresh"></i> 刷 新
                            </button>
                        </shiro:hasPermission>
                        <shiro:hasPermission name="staticpeopletocity:export">
...
<%@ include file="/WEB-INF/views/admin/staticpeopletocity/staticpeopletocityView.jsp" %>

<!-- js -->
<%@ include file="/WEB-INF/views/admin/staticpeopletocity/staticpeopletocityjs.jsp" %>
