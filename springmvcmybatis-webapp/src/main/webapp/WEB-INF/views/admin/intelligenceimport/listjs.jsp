    ...
    $().ready(function () {
        ...
        tables = $("#data-table")
                .dataTable({
                    ...
                    ajax: {
                        type: "post",
                        url: "${ctxPath}/admin/intelligenceimport/queryList",
                    ...
                    <shiro:lacksPermission name="intelligenceimport:batchdelete">
                    "order": [[1, "desc"]],
                    ...
                    columnDefs: [
                        ...
                        <myshiro:hasAnyPermission permissions="intelligenceimport:edit,intelligenceimport:delete">
                        {
                            ...
                            <shiro:hasPermission name="intelligenceimport:edit">
                            ...
                            <shiro:hasPermission name="intelligenceimport:delete">
        ...
        $("#btn-add").on("click", function () {
            url = "${ctxPath}/admin/intelligenceimport/addAndUpload";
            $("#edit-modal-label").html("添加");
            $("#edit-form :input").val("");
            $("#fileType").find("option").eq(0).attr("selected", "selected");
            $("#collectTime").val(getNowFormatDate());
        ...
        $("#data-table tbody").on("click", "#btn-edit-row", function () {
            url = "${ctxPath}/admin/intelligenceimport/updateAndUpload";
        ...
        $("#btn-operate-confirm").on("click", function () {
            ...
            if (operateType == deleteToOperateConfirmFlag) {
                url = "${ctxPath}/admin/intelligenceimport/" + operateTypeIds + "/delete";
                data = "";
            } else if (operateType == batchDeleteToOperateConfirmFlag) {
                url = "${ctxPath}/admin/intelligenceimport/batch/delete";
                data = operateTypeIds;
            }
