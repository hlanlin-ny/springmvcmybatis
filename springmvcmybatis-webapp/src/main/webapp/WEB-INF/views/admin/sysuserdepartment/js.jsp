    ...
    $().ready(function () {
        ...
        tables = $("#data-table")
                .dataTable({
                    ...
                    ajax: {
                        type: "post",
                        url: "${ctxPath}/admin/sysuserdepartment/queryList",
                    ...
                    <shiro:lacksPermission name="sysuserdepartment:batchdelete">
                    "order": [[1, "desc"]],
                    ...
                    columnDefs: [
                        ...
                        <myshiro:hasAnyPermission permissions="sysuserdepartment:edit,sysuserdepartment:delete">
                        {
                            ...
                            <shiro:hasPermission name="sysuserdepartment:edit">
                            ...
                            <shiro:hasPermission name="sysuserdepartment:delete">
        ...
        $("#btn-add").on("click", function () {
            url = "${ctxPath}/admin/sysuserdepartment/add";
        ...
        $("#data-table tbody").on("click", "#btn-edit-row", function () {
            url = "${ctxPath}/admin/sysuserdepartment/update";
        ...
        $("#btn-operate-confirm").on("click", function () {
            ...
            if (operateType == deleteToOperateConfirmFlag) {
                url = "${ctxPath}/admin/sysuserdepartment/" + operateTypeIds + "/delete";
                data = "";
            } else if (operateType == batchDeleteToOperateConfirmFlag) {
                url = "${ctxPath}/admin/sysuserdepartment/batch/delete";
                data = operateTypeIds;
            }
        ...
        $("#parentName").on("click", function () {
            ...
            $.get("${ctxPath}/admin/sysuserdepartment/queryAllNodes", function (data) {
