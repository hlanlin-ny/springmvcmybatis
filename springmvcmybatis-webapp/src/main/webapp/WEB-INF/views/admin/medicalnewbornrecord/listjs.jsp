    ...
    $().ready(function () {
        ...
        tables = $("#data-table")
                .dataTable({
                    ...
                    ajax: {
                        type: "post",
                        url: "${ctxPath}/admin/medicalnewbornrecord/queryList",
                    ...
                    columns: [
                        ...
                        {"data": "motherName", defaultContent: "", "bSortable": false},
                        {"data": "fatherName", defaultContent: "", "bSortable": false},
                        {"data": "checkInDatetime", defaultContent: ""}
                        <myshiro:hasAnyPermission permissions="medicalnewbornrecord:detail">
                        ,
        ...
        $("#btn-update").on("click", function () {
            $.ajax({
                cache: "false",
                url: "${ctxPath}/admin/medicalnewbornrecord/updatetocommon",
                type: "POST",
                data: null,
                contentType: "application/json;charset=UTF-8",
                success: function (data) {
