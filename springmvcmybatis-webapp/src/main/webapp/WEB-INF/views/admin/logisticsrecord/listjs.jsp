    ...
    $().ready(function () {
        ...
        tables = $("#data-table")
                .dataTable({
                    ...
                    ajax: {
                        type: "post",
                        url: "${ctxPath}/admin/logisticsrecord/queryList",
                    ...
                    <shiro:lacksPermission name="logisticsrecord:batchdelete">
                    "order": [[1, "desc"]],
                    </shiro:lacksPermission>
                    <shiro:hasPermission name="logisticsrecord:batchdelete">
                    "order": [[2, "desc"]],
                    </shiro:hasPermission>
                    columns: [
                        <shiro:hasPermission name="logisticsrecord:batchdelete">
                        ...
                        <myshiro:hasAnyPermission permissions="logisticsrecord:edit,logisticsrecord:delete">
                        ,
                        {"data": null, "bSortable": false}
                    ...
                    columnDefs: [
                        ...
                        <myshiro:hasAnyPermission permissions="logisticsrecord:edit,logisticsrecord:delete">
                        {
                            ...
                            <shiro:hasPermission name="logisticsrecord:edit">
                            ...
                            <shiro:hasPermission name="logisticsrecord:delete">
        ...
        $("#btn-add").on("click", function () {
            url = "${ctxPath}/admin/logisticsrecord/add";
        ...
        $("#data-table tbody").on("click", "#btn-edit-row", function () {
            url = "${ctxPath}/admin/logisticsrecord/update";
        ...
        $("#btn-operate-confirm").on("click", function () {
            ...
            if (operateType == deleteToOperateConfirmFlag) {
                url = "${ctxPath}/admin/logisticsrecord/" + operateTypeIds + "/delete";
                data = "";
            } else if (operateType == batchDeleteToOperateConfirmFlag) {
                url = "${ctxPath}/admin/logisticsrecord/batch/delete";
                data = operateTypeIds;
            }
        ...
        $.get("${ctxPath}/admin/logisticsuser/queryLogisticsUsersByAreaId", function (data) {
            $.each(data.result,
                    function (i, result) {
