...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            <shiro:hasPermission name="logisticsrecord:search">
                <!-- form start -->
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <shiro:hasPermission name="logisticsrecord:add">
                        ...
                        <shiro:hasPermission name="logisticsrecord:refersh">
                            <button id="btn-refresh" type="button" class="btn btn-default">
                                <i class="fa fa-refresh"></i> 刷 新
                            </button>
                        </shiro:hasPermission>
                        <shiro:hasPermission name="logisticsrecord:export">
...
<!-- /.content -->
<%@ include file="/WEB-INF/views/admin/logisticsrecord/edit.jsp" %>
<%@ include file="/WEB-INF/views/admin/common/operateconfirmmodal.jsp" %>

<!-- js -->
<%@ include file="/WEB-INF/views/admin/logisticsrecord/listjs.jsp" %>
