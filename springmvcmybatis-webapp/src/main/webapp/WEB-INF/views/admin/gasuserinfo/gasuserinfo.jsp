...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            <shiro:hasPermission name="gasuserinfo:search">
                <!-- form start -->
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <label for="extra-search-cyzjhm" class="col-sm-2 control-label">身份号码</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="extra-search-cyzjhm"
                                           name="extra-search-cyzjhm" placeholder="身份号码"/>
                                </div>
                            </div>
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <shiro:hasPermission name="gasuserinfo:refersh">
                            <button id="btn-refresh" type="button" class="btn btn-default">
                                <i class="fa fa-refresh"></i> 刷 新
                            </button>
                        </shiro:hasPermission>
                        <shiro:hasPermission name="gasuserinfo:export">
...
<%@ include file="/WEB-INF/views/admin/gasuserinfo/gasuserinfoView.jsp" %>

<!-- js -->
<%@ include file="/WEB-INF/views/admin/gasuserinfo/gasuserinfojs.jsp" %>
