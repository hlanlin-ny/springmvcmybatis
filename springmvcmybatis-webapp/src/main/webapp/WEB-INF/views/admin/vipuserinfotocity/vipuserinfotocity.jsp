...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            <shiro:hasPermission name="vipuserinfotocity:search">
                <!-- form start -->
                <form id="query-form" class="form-horizontal">
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="extra-search-xzddzmc" class="col-sm-2 control-label">现住地地址名称</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="extra-search-xzddzmc"
                                           name="extra-search-xzddzmc" placeholder="现住地地址名称"/>
                                </div>
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <shiro:hasPermission name="vipuserinfotocity:refersh">
...
<%@ include file="/WEB-INF/views/admin/vipuserinfotocity/vipuserinfotocityView.jsp" %>

<!-- js -->
<%@ include file="/WEB-INF/views/admin/vipuserinfotocity/vipuserinfotocityjs.jsp" %>
