        ...
        <div class="modal-content">
            ...
            <form id="edit-form" name="edit-form" class="form-horizontal">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="xzzDzmc" class="col-sm-2 control-label">户籍地址</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" readonly id="xzzDzmc" name="xzzDzmc" placeholder="户籍地址"/>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="ysxz" class="col-sm-2 control-label">用水性质</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" readonly id="ysxz" name="ysxz" placeholder="用水性质"/>
                        </div>
                    </div>
                </div>
