...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            <shiro:hasPermission name="wateruserinfo:search">
                <!-- form start -->
                <form id="query-form" class="form-horizontal">
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="extra-search-ysxz" class="col-sm-2 control-label">用水性质</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="extra-search-ysxz"
                                           name="extra-search-ysxz" placeholder="用水性质"/>
                                </div>

                                <label for="extra-search-yddh" class="col-sm-2 control-label">移动电话</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="extra-search-yddh"
                                           name="extra-search-yddh" placeholder="移动电话"/>
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="extra-search-xzzDzmc" class="col-sm-2 control-label">现住地址名称</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="extra-search-xzzDzmc"
                                           name="extra-search-xzzDzmc" placeholder="现住地址名称"/>
                                </div>
                            </div>
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <shiro:hasPermission name="wateruserinfo:refersh">
                            <button id="btn-refresh" type="button" class="btn btn-default">
                                <i class="fa fa-refresh"></i> 刷 新
                            </button>
                        </shiro:hasPermission>
                        <shiro:hasPermission name="wateruserinfo:export">
...
<%@ include file="/WEB-INF/views/admin/wateruserinfo/wateruserinfoView.jsp" %>

<!-- js -->
<%@ include file="/WEB-INF/views/admin/wateruserinfo/wateruserinfojs.jsp" %>
