    ...
    $().ready(function () {
        ...
        tables = $("#data-table")
                .dataTable({
                    ...
                    ajax: {
                        type: "post",
                        url: "${ctxPath}/admin/commontool/queryList",
                    ...
                    <shiro:lacksPermission name="commontool:batchdelete">
                    "order": [[1, "desc"]],
                    </shiro:lacksPermission>
                    <shiro:hasPermission name="commontool:batchdelete">
                    "order": [[2, "desc"]],
                    </shiro:hasPermission>
                    columns: [
                        <shiro:hasPermission name="commontool:batchdelete">
                        ...
                        <myshiro:hasAnyPermission permissions="commontool:edit,commontool:delete">
                        ,
                        {"data": null, "bSortable": false}
                    ...
                    columnDefs: [
                        ...
                        <myshiro:hasAnyPermission permissions="commontool:edit,commontool:delete">
                        {
                            ...
                            <shiro:hasPermission name="commontool:edit">
                            ...
                            <shiro:hasPermission name="commontool:delete">
        ...
        $("#btn-add").on("click", function () {
            url = "${ctxPath}/admin/commontool/add";
        ...
        $("#data-table tbody").on("click", "#btn-edit-row", function () {
            url = "${ctxPath}/admin/commontool/update";
        ...
        $("#btn-operate-confirm").on("click", function () {
            ...
            if (operateType == deleteToOperateConfirmFlag) {
                url = "${ctxPath}/admin/commontool/" + operateTypeIds + "/delete";
                data = "";
            } else if (operateType == batchDeleteToOperateConfirmFlag) {
                url = "${ctxPath}/admin/commontool/batch/delete";
                data = operateTypeIds;
            }
