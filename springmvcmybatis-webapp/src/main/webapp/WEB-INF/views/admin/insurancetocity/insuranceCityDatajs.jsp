    ...
    $().ready(function () {
        ...
        tables = $("#data-table")
                .dataTable({
                    ...
                    ajax: {
                        type: "post",
                        url: "${ctxPath}/admin/insurancetocity/queryList",
                    ...
                    columns: [
                        ...
                        {"data": "sbkh", defaultContent: ""},
                        {"data": "bldwDwmc", defaultContent: ""},
                        {"data": "djsj"},
                        <myshiro:hasAnyPermission permissions="insurancetocity:export">
...
//                    + seperator2 + date.getSeconds();
    ...
    $("#data-table tbody").on("click", "#btn-edit-row", function () {
        ...
        $("#mz").val(data.mz);
        $("#csrq").val(data.csrq);
        $("#cyzjmc").val(data.cyzjmc);
        $("#zjhm").val(data.zjhm);
        $("#sbkh").val(data.sbkh);
        $("#bldwDwmc").val(data.bldwDwmc);
        $("#djrXm").val(data.djrXm);
        $("#djsj").val(data.djsj);
        ...
        $("#xb").parent().parent().show();
        $("#mz").parent().parent().show();
        $("#csrq").parent().parent().show();
        $("#cyzjmc").parent().parent().show();
        $("#zjhm").parent().parent().show();
        $("#sbkh").parent().parent().show();
        $("#bldwDwmc").parent().parent().show();
        $("#djrXm").parent().parent().show();
        $("#djsj").parent().parent().show();
