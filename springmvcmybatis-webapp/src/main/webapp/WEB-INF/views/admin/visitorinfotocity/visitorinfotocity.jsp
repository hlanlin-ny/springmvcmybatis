...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            <shiro:hasPermission name="visitorinfotocity:search">
                <!-- form start -->
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <shiro:hasPermission name="visitorinfotocity:refersh">
                            <button id="btn-refresh" type="button" class="btn btn-default">
                                <i class="fa fa-refresh"></i> 刷 新
                            </button>
                        </shiro:hasPermission>
                        <shiro:hasPermission name="visitorinfotocity:export">
...
<%@ include file="/WEB-INF/views/admin/visitorinfotocity/visitorinfotocityView.jsp" %>

<!-- js -->
<%@ include file="/WEB-INF/views/admin/visitorinfotocity/visitorinfotocityjs.jsp" %>
