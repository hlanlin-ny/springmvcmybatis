    ...
    $().ready(function () {
        ...
        tables = $("#data-table")
                .dataTable({
                    ...
                    ajax: {
                        type: "post",
                        url: "${ctxPath}/admin/updatingfilecount/queryList",
                    ...
                    <shiro:lacksPermission name="updatingfilecount:batchdelete">
                    "order": [[1, "desc"]],
                    </shiro:lacksPermission>
                    <shiro:hasPermission name="updatingfilecount:batchdelete">
                    "order": [[2, "desc"]],
                    </shiro:hasPermission>
                    columns: [
                        <shiro:hasPermission name="updatingfilecount:batchdelete">
                       ...
                       /* <myshiro:hasAnyPermission permissions="updatingfilecount:edit,updatingfilecount:delete">
                        ,
                        {"data": null, "bSortable": false}
                    ...
                    columnDefs: [
                        ...
                        <myshiro:hasAnyPermission permissions="updatingfilecount:edit,updatingfilecount:delete">
                        {
                            ...
                            <shiro:hasPermission name="updatingfilecount:edit">
                            ...
                            <shiro:hasPermission name="updatingfilecount:delete">
        ...
        $("#btn-add").on("click", function () {
            url = "${ctxPath}/admin/updatingfilecount/add";
        ...
        $("#btn-queryTotal").on("click", function () {
            ...
            $.ajax({
                url : "${ctxPath}/admin/updatingfilecount/querySum", //目标地址
                type : "POST",  //ajax发送方法
                async : true,  //异步
                data : "14",
                dataType : "json",
        ...
        $("#btn-operate-confirm").on("click", function () {
            ...
            if (operateType == deleteToOperateConfirmFlag) {
                url = "${ctxPath}/admin/updatingfilecount/" + operateTypeIds + "/delete";
                data = "";
            } else if (operateType == batchDeleteToOperateConfirmFlag) {
                url = "${ctxPath}/admin/updatingfilecount/batch/delete";
                data = operateTypeIds;
            }
