...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            <shiro:hasPermission name="hospitaluser:search">
                <!-- form start -->
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="extra-search-hospitalId" class="col-sm-2 control-label">所属医院</label>

                                <div class="col-sm-4">
                                    <select class="form-control select2" id="extra-search-hospitalId"
                                            name="extra-search-hospitalId" style="width: 100%;"></select>
                                </div>
                            ...
                            <div class="form-group">
                                <label for="extra-search-address" class="col-sm-2 control-label">地址</label>

                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="extra-search-address"
                                           name="extra-search-address" placeholder="地址"/>
                                </div>
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <shiro:hasPermission name="hospitaluser:add">
                        ...
                        <shiro:hasPermission name="hospitaluser:refersh">
                            <button id="btn-refresh" type="button" class="btn btn-default">
                                <i class="fa fa-refresh"></i> 刷 新
                            </button>
                        </shiro:hasPermission>
                        <shiro:hasPermission name="hospitaluser:export">
...
<!-- /.content -->
<%@ include file="/WEB-INF/views/admin/hospitaluser/edit.jsp" %>
<%@ include file="/WEB-INF/views/admin/common/operateconfirmmodal.jsp" %>

<!-- js -->
<%@ include file="/WEB-INF/views/admin/hospitaluser/listjs.jsp" %>
