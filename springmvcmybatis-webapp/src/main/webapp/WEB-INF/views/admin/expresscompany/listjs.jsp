    ...
    $().ready(function () {
        ...
        tables = $("#data-table")
                .dataTable({
                    ...
                    ajax: {
                        type: "post",
                        url: "${ctxPath}/admin/expresscompany/queryList",
                    ...
                    <shiro:lacksPermission name="expresscompany:batchdelete">
                    "order": [[1, "desc"]],
                    ...
                    columnDefs: [
                        ...
                        <myshiro:hasAnyPermission permissions="expresscompany:edit,expresscompany:delete">
                        {
                            ...
                            <shiro:hasPermission name="expresscompany:edit">
        ...
        $("#btn-add").on("click", function () {
            url = "${ctxPath}/admin/expresscompany/add";
        ...
        $("#data-table tbody").on("click", "#btn-edit-row", function () {
            url = "${ctxPath}/admin/expresscompany/update";
        ...
        $("#btn-operate-confirm").on("click", function () {
            ...
            if (operateType == deleteToOperateConfirmFlag) {
                url = "${ctxPath}/admin/expresscompany/" + operateTypeIds + "/delete";
                data = "";
            } else if (operateType == batchDeleteToOperateConfirmFlag) {
                url = "${ctxPath}/admin/expresscompany/batch/delete";
                data = operateTypeIds;
            }
