    ...
    $().ready(function () {
        ...
        tables = $("#data-table")
                .dataTable({
                    ...
                    ajax: {
                        type: "post",
                        url: "${ctxPath}/admin/medicalParkingToCityTransfer/queryList",
                    ...
                    columns: [
                        ...
                        <myshiro:hasAnyPermission permissions="medicalparkingtocitytransfer:export">
...
//                    + seperator2 + date.getSeconds();
    ...
    $("#data-table tbody").on("click", "#btn-edit-row", function () {
        ...
        $("#edit-form :input").val("");
        $("#id").val(data.id);
        $("#tccbh").val(data.tccbh);
        $("#fxfs").val(data.fxfs);
        $("#gcbh").val(data.gcbh);
        $("#csysdm").val(data.csysdm);
        $("#jcSj").val(data.jcSj);
        $("#ccSj").val(data.ccSj);
        $("#jczt").val(data.jczt);
        $("#cpys").val(data.cpys);
        $("#jdccllxdm").val(data.jdccllxdm);
        $("#jdchphm").val(data.jdchphm);



        $("#edit-form :input").parent().parent().hide();
        $("#id").parent().parent().show();
        $("#tccbh").parent().parent().show();
        $("#fxfs").parent().parent().show();
        $("#gcbh").parent().parent().show();
        $("#csysdm").parent().parent().show();
        $("#jcSj").parent().parent().show();
        $("#ccSj").parent().parent().show();
        $("#jczt").parent().parent().show();
        $("#cpys").parent().parent().show();
        $("#jdccllxdm").parent().parent().show();
        $("#jdchphm").parent().parent().show();
