    ...
    $().ready(function () {
        ...
        tables = $("#data-table")
                .dataTable({
                    ...
                    ajax: {
                        type: "post",
                        url: "${ctxPath}/admin/gasfeeinfotocity/queryList",
                    ...
                    columns: [
                        ...
                        <myshiro:hasAnyPermission permissions="gasfeeinfotocity:export">
...
//                    + seperator2 + date.getSeconds();
    ...
    $("#data-table tbody").on("click", "#btn-edit-row", function () {
        ...
        $("#edit-form :input").val("");
        $("#id").val(data.id);
        $("#METCARDNAME").val(data.METCARDNAME);
        $("#SHOULDEARN").val(data.SHOULDEARN);
        $("#ACTUALEARN").val(data.ACTUALEARN);
        $("#CHARGETIME").val(data.CHARGETIME);
        $("#ACCOUNT_CUBE").val(data.ACCOUNT_CUBE);
        $("#METERED_CUBE").val(data.METERED_CUBE);
        $("#METERED_TIME").val(data.METERED_TIME);
