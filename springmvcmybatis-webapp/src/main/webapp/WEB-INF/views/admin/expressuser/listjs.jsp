    ...
    $().ready(function () {
        ...
        tables = $("#data-table")
                .dataTable({
                    ...
                    ajax: {
                        type: "post",
                        url: "${ctxPath}/admin/expressuser/queryList",
                    ...
                    <shiro:lacksPermission name="expressuser:batchdelete">
                    "order": [[1, "desc"]],
                    </shiro:lacksPermission>
                    <shiro:hasPermission name="expressuser:batchdelete">
                    "order": [[2, "desc"]],
                    </shiro:hasPermission>
                    columns: [
                        <shiro:hasPermission name="expressuser:batchdelete">
                        ...
                        <myshiro:hasAnyPermission permissions="expressuser:edit,expressuser:delete">
                        ,
                        {"data": null, "bSortable": false}
                    ...
                    columnDefs: [
                        ...
                        <myshiro:hasAnyPermission permissions="expressuser:edit,expressuser:delete">
                        {
                            ...
                            <shiro:hasPermission name="expressuser:edit">
                            ...
                            <shiro:hasPermission name="expressuser:delete">
        ...
        $("#btn-add").on("click", function () {
            url = "${ctxPath}/admin/expressuser/add";
        ...
        $("#data-table tbody").on("click", "#btn-edit-row", function () {
            url = "${ctxPath}/admin/expressuser/update";
...
//            $("#seckey").val(data.seckey);
        ...
        $("#btn-operate-confirm").on("click", function () {
            ...
            if (operateType == deleteToOperateConfirmFlag) {
                url = "${ctxPath}/admin/expressuser/" + operateTypeIds + "/delete";
                data = "";
            } else if (operateType == batchDeleteToOperateConfirmFlag) {
                url = "${ctxPath}/admin/expressuser/batch/delete";
                data = operateTypeIds;
            }
        ...
        $.get("${ctxPath}/admin/expresscompany/queryExpressCompanysByAreaId", function (data) {
            $.each(data.result,
                    function (i, result) {
