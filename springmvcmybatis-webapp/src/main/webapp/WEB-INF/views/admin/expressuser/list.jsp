...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            <shiro:hasPermission name="expressuser:search">
                <!-- form start -->
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <shiro:hasPermission name="expressuser:add">
                        ...
                        <shiro:hasPermission name="expressuser:refersh">
                            <button id="btn-refresh" type="button" class="btn btn-default">
                                <i class="fa fa-refresh"></i> 刷 新
                            </button>
                        </shiro:hasPermission>
                        <shiro:hasPermission name="expressuser:export">
...
<!-- /.content -->
<%@ include file="/WEB-INF/views/admin/expressuser/edit.jsp" %>
<%@ include file="/WEB-INF/views/admin/common/operateconfirmmodal.jsp" %>

<!-- js -->
<%@ include file="/WEB-INF/views/admin/expressuser/listjs.jsp" %>
