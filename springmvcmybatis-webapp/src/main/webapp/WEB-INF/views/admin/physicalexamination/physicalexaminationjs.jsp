    ...
    $().ready(function () {
        ...
        tables = $("#data-table")
                .dataTable({
                    ...
                    ajax: {
                        type: "post",
                        url: "${ctxPath}/admin/physicalexamination/queryList",
                    ...
                    columns: [
                        ...
                        <myshiro:hasAnyPermission permissions="physicalexamination:export">
...
//                    + seperator2 + date.getSeconds();
    ...
    $("#data-table tbody").on("click", "#btn-edit-row", function () {
        ...
        $("#zy").val(data.zy);
        $("#fwcs").val(data.fwcs);
        $("#yyDwmc").val(data.yyDwmc);
        $("#ybzZjhm").val(data.ybzZjhm);
        $("#ksDwmc").val(data.ksDwmc);
        $("#ysXm").val(data.ysXm);
        $("#ryzdJyqk").val(data.ryzdJyqk);
        $("#cyrq").val(data.cyrq);
