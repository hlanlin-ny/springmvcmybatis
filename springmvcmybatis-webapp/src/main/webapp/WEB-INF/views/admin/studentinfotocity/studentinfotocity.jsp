...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            <shiro:hasPermission name="studentinfotocity:search">
                <!-- form start -->
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <shiro:hasPermission name="studentinfotocity:refersh">
                            <button id="btn-refresh" type="button" class="btn btn-default">
                                <i class="fa fa-refresh"></i> 刷 新
                            </button>
                        </shiro:hasPermission>
                        <shiro:hasPermission name="studentinfotocity:export">
...
<%@ include file="/WEB-INF/views/admin/studentinfotocity/studentinfotocityView.jsp" %>

<!-- js -->
<%@ include file="/WEB-INF/views/admin/studentinfotocity/studentinfotocityjs.jsp" %>
