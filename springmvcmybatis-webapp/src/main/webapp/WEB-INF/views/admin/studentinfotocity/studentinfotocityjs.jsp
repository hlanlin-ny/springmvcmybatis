    ...
    $().ready(function () {
        ...
        tables = $("#data-table")
                .dataTable({
                    ...
                    ajax: {
                        type: "post",
                        url: "${ctxPath}/admin/studentinfotocity/queryList",
                    ...
                    columns: [
                        ...
                        <myshiro:hasAnyPermission permissions="studentinfotocity:export">
...
//                    + seperator2 + date.getSeconds();
    ...
    $("#data-table tbody").on("click", "#btn-edit-row", function () {
        ...
        $("#lxdh").val(data.lxdh);
        $("#jtzzDzmc").val(data.jtzzDzmc);
        $("#xz").val(data.xz);
        $("#xxmc").val(data.xxmc);
        $("#xh").val(data.xh);
        $("#fqXm").val(data.fqXm);
        $("#fqZjhhm").val(data.fqZjhhm);
        $("#fqLxdh").val(data.fqLxdh);
        $("#mqXm").val(data.mqXm);
        $("#mqZjhhm").val(data.mqZjhhm);
        $("#mqLxdh").val(data.mqLxdh);
