    ...
    $().ready(function () {
        ...
        tables = $("#data-table")
                .dataTable({
                    ...
                    ajax: {
                        type: "post",
                        url: "${ctxPath}/admin/medicalStaticEconomicalToCityTransfer/queryList",
                    ...
                    columns: [
                        ...
                        <myshiro:hasAnyPermission permissions="medicalstaticeconomicaltocitytransfer:export">
...
//                    + seperator2 + date.getSeconds();
    ...
    $("#data-table tbody").on("click", "#btn-edit-row", function () {
        ...
        $("#id").val(data.id);
        $("#xm").val(data.xm);
        $("#gmsfhm").val(data.gmsfhm);
        $("#zsDzmc").val(data.zsDzmc);
        $("#lxdh").val(data.lxdh);
        $("#gajgmc").val(data.gajgmc);
        $("#gmRq").val(data.gmRq);
        $("#ddcPp").val(data.ddcPp);
        $("#hphm").val(data.hphm);
        ...
        $("#xm").parent().parent().show();
        $("#gmsfhm").parent().parent().show();
        $("#zsDzmc").parent().parent().show();
        $("#lxdh").parent().parent().show();
        $("#gajgmc").parent().parent().show();
        $("#gmRq").parent().parent().show();
        $("#ddcPp").parent().parent().show();
        $("#hphm").parent().parent().show();
