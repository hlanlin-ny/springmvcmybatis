    ...
    $().ready(function () {
        ...
        tables = $("#data-table")
                .dataTable({
                    ...
                    ajax: {
                        type: "post",
                        url: "${ctxPath}/admin/medicalLettersCallsToCity/queryList",
                    ...
                    columns: [
                        ...
                        <myshiro:hasAnyPermission permissions="medicalletterscallstocity:export">
...
//                    + seperator2 + date.getSeconds();
    ...
    $("#data-table tbody").on("click", "#btn-edit-row", function () {
        ...
        $("#edit-form :input").val("");
        $("#id").val(data.id);
        $("#xfrXm").val(data.xfrXm);
        $("#sfrq").val(data.sfrq);
        $("#xfrGmsfhm").val(data.xfrGmsfhm);
        $("#xfrLxdh").val(data.xfrLxdh);
        $("#sldwDwmc").val(data.sldwDwmc);
        $("#xfsyJyqk").val(data.xfsyJyqk);
        $("#gjxwJyqk").val(data.gjxwJyqk);
