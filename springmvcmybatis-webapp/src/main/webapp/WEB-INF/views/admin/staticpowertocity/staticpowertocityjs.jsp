    ...
    $().ready(function () {
        ...
        tables = $("#data-table")
                .dataTable({
                    ...
                    ajax: {
                        type: "post",
                        url: "${ctxPath}/admin/staticpowerdatatocity/queryList",
                    ...
                    columns: [
                        ...
                        <myshiro:hasAnyPermission permissions="staticpeopletocity:export">
...
//                    + seperator2 + date.getSeconds();
    ...
    $("#data-table tbody").on("click", "#btn-edit-row", function () {
        ...
        $("#zjhm").val(data.zjhm);
        $("#lxdh").val(data.lxdh);
        $("#hjdzDzmc").val(data.hjdzDzmc);
        $("#zyzgmc").val(data.zyzgmc);
        $("#dwmc").val(data.dwmc);
