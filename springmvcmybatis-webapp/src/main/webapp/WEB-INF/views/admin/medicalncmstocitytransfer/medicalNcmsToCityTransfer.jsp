...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            <shiro:hasPermission name="medicalncmstocitytransfer:search">
                <!-- form start -->
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <label for="extra-search-sfxh" class="col-sm-2 control-label">身份证号</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="extra-search-sfxh"
                                           name="extra-search-sfxh" placeholder="身份证号"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="extra-search-ylkh" class="col-sm-2 control-label">医疗卡号</label>
                                <div class="col-sm-4">
                                    <input  type="text" class="form-control" id="extra-search-ylkh"
                                           name="extra-search-ylkh" placeholder="医疗卡号"/>
                                </div>
                            </div>
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <shiro:hasPermission name="medicalncmstocitytransfer:refersh">
                            <button id="btn-refresh" type="button" class="btn btn-default">
                                <i class="fa fa-refresh"></i> 刷 新
                            </button>
                        </shiro:hasPermission>
                        <shiro:hasPermission name="medicalncmstocitytransfer:export">
...
<%@ include file="/WEB-INF/views/admin/medicalncmstocitytransfer/medicalNcmsToCityTransferView.jsp" %>

<!-- js -->
<%@ include file="/WEB-INF/views/admin/medicalncmstocitytransfer/medicalNcmsToCityTransferjs.jsp" %>
