    ...
    $().ready(function () {
        ...
        tables = $("#data-table")
                .dataTable({
                    ...
                    ajax: {
                        type: "post",
                        url: "${ctxPath}/admin/medicalNcmsToCityTransfer/queryList",
                    ...
                    columns: [
                        ...
                        <myshiro:hasAnyPermission permissions="medicalncmstocitytransfer:export">
...
//                    + seperator2 + date.getSeconds();
    ...
    $("#data-table tbody").on("click", "#btn-edit-row", function () {
        ...
        $("#dz").val(data.dz);
        $("#rklx").val(data.rklx);
        $("#xxcjdw").val(data.xxcjdw);
        $("#xxcjsl").val(data.xxcjsl);
        $("#xxxl").val(data.xxxl);
        ...
        $("#ylkh").parent().parent().show();
        $("#sfxh").parent().parent().show();
        $("#dz").parent().parent().show();
        $("#rklx").parent().parent().show();
        $("#xxcjdw").parent().parent().show();
        $("#xxcjsl").parent().parent().show();
        $("#xxxl").parent().parent().show();
