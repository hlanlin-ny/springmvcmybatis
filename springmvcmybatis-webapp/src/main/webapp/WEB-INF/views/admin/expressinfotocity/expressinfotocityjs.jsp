    ...
    $().ready(function () {
        ...
        tables = $("#data-table")
                .dataTable({
                    ...
                    ajax: {
                        type: "post",
                        url: "${ctxPath}/admin/expressinfotocity/queryList",
                    ...
                    columns: [
                        ...
                        <myshiro:hasAnyPermission permissions="expressinfotocity:export">
...
//                    + seperator2 + date.getSeconds();
    ...
    $("#data-table tbody").on("click", "#btn-edit-row", function () {
        ...
        $("#id").val(data.id);
        $("#YDH").val(data.YDH);
        $("#wlzx_DWMC").val(data.wlzx_DWMC);
        $("#fahr_XM").val(data.fahr_XM);
        $("#fahr_ZJHM").val(data.fahr_ZJHM);
        $("#fahr_LXDH").val(data.fahr_LXDH);
        $("#JJSJ").val(data.JJSJ);
        $("#shhr_XM").val(data.shhr_XM);
        $("#shhr_ZJHM").val(data.shhr_ZJHM);
        $("#shhr_LXDH").val(data.shhr_LXDH);
        $("#SHSJ").val(data.SHSJ);
