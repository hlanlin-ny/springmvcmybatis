...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            <shiro:hasPermission name="hospitalunitinformation:search">
                <!-- form start -->
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="extra-search-hospitalName" class="col-sm-2 control-label">医院名称</label>

                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="extra-search-hospitalName"
                                           name="extra-search-hospitalName" placeholder="医院名称"/>
                                </div>
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <shiro:hasPermission name="hospitalunitinformation:add">
                        ...
                        <shiro:hasPermission name="hospitalunitinformation:refersh">
                            <button id="btn-refresh" type="button" class="btn btn-default">
                                <i class="fa fa-refresh"></i> 刷 新
                            </button>
                        </shiro:hasPermission>
                        <%--<shiro:hasPermission name="hospitalunitinformation:export">--%>
                    ...
                    <table id="data-table" class="table table-hover table-striped">
                        ...
                        <tr>
                            ...
                            <myshiro:hasAnyPermission
                                    permissions="hospitalunitinformation:edit,hospitalunitinformation:delete">
                                <th>操作</th>
                            </myshiro:hasAnyPermission>
                        </tr>
                        </thead>
...
<!-- /.content -->
<%@ include file="/WEB-INF/views/admin/hospitalunitinformation/edit.jsp" %>
<%@ include file="/WEB-INF/views/admin/common/operateconfirmmodal.jsp" %>

<!-- js -->
<%@ include file="/WEB-INF/views/admin/hospitalunitinformation/listjs.jsp" %>
