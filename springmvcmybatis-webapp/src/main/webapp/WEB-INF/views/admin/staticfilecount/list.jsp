...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
           <shiro:hasPermission name="staticfilecount:search">
                <!-- form start -->
            ...
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        ...
                        <shiro:hasPermission name="staticfilecount:refersh">
                        ...
                        <shiro:hasPermission name="staticfilecount:export">
                    ...
                    <table id="data-table" class="table table-hover table-striped">
                        <thead>
                            <tr>
                                ...
                                <th>未上传数量</th>
                                <th>已上传数据</th>
                                <%--<myshiro:hasAnyPermission permissions="staticfilecount:refersh,staticfilecount:refersh">
                                    <th>操作</th>
...
<!-- /.content -->
<%@ include file="/WEB-INF/views/admin/staticfilecount/edit.jsp" %>
<%@ include file="/WEB-INF/views/admin/staticfilecount/tree.jsp" %>
<%@ include file="/WEB-INF/views/admin/common/operateconfirmmodal.jsp" %>

<!-- js -->
<%@ include file="/WEB-INF/views/admin/staticfilecount/listjs.jsp" %>
