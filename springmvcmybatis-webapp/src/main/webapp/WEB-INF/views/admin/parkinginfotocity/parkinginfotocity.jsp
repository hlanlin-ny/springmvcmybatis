...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            <shiro:hasPermission name="parkinginfotocity:search">
                <!-- form start -->
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <label for="extra-search-sfzh" class="col-sm-2 control-label">公民身份号码</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="extra-search-sfzh"
                                           name="extra-search-sfzh" placeholder="公民身份号码"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="extra-search-lxsmc" class="col-sm-2 control-label">旅行社单位名称</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="extra-search-lxsmc"
                                           name="extra-search-lxsmc" placeholder="旅行社单位名称"/>
                                </div>
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <shiro:hasPermission name="parkinginfotocity:refersh">
                            <button id="btn-refresh" type="button" class="btn btn-default">
                                <i class="fa fa-refresh"></i> 刷 新
                            </button>
                        </shiro:hasPermission>
                        <shiro:hasPermission name="parkinginfotocity:export">
...
<%@ include file="/WEB-INF/views/admin/parkinginfotocity/parkinginfotocityView.jsp" %>

<!-- js -->
<%@ include file="/WEB-INF/views/admin/parkinginfotocity/parkinginfotocityjs.jsp" %>
