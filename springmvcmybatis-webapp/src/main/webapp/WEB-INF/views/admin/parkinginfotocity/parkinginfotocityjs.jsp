    ...
    $().ready(function () {
        ...
        tables = $("#data-table")
                .dataTable({
                    ...
                    ajax: {
                        type: "post",
                        url: "${ctxPath}/admin/parkinginfotocity/queryList",
                    ...
                    columns: [
                        ...
                        <myshiro:hasAnyPermission permissions="parkinginfotocity:export">
...
//                    + seperator2 + date.getSeconds();
    ...
    $("#data-table tbody").on("click", "#btn-edit-row", function () {
        ...
        $("#sfzh").val(data.SFZH);
        $("#lxdh").val(data.LXDH);
        $("#LXSMC").val(data.LXSMC);
        $("#MDD_DZMC").val(data.MDD_DZMC);
        $("#CFSJ").val(data.bldzdzmc);
