    ...
    $().ready(function () {
        ...
        tables = $("#data-table")
                .dataTable({
                    ...
                    ajax: {
                        type: "post",
                        url: "${ctxPath}/admin/accumulationfundtocity/queryList",
                    ...
                    columns: [
                        ...
                        <myshiro:hasAnyPermission permissions="accumulationfundtocity:export">
...
//                    + seperator2 + date.getSeconds();
    ...
    $("#data-table tbody").on("click", "#btn-edit-row", function () {
        ...
        $("#xb").val(data.xb);
        $("#zjhm").val(data.zjhm);
        $("#xzzDzmc").val(data.xzzDzmc);
        $("#fwcs").val(data.fwcs);
        $("#djdwGajgmc").val(data.djdwGajgmc);
        $("#djsj").val(data.djsj);
