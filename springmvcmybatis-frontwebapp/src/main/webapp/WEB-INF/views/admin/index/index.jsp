                    ...
                    <div class="col-md-12">
                        ...
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs">
                                ...
                                <li id="li_tab_2"><a href="#tab_1" data-toggle="tab">标准化数据</a></li>
                                <li id="li_tab_3"><a href="#tab_2" data-toggle="tab">文件数据</a></li>
                            </ul>
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab_1">
                                    <form id="dataSearchForm" name="dataSearchForm" method="post"
                                          action="${ctxPath}/admin/search/searchKeyword">
                                        <div class="row">
                                            <div class="col-md-12">&nbsp;
                                                ...
                                                <input type="hidden" class="form-control" id="preciseQuery"
                                                       name="preciseQuery" value="0">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                            ...
                                            <span class="input-group-addon"><i
                                                    ...
                                                    <input id="keyword" name="keyword" autocomplete="off"
                                                           data-provide="typeahead" type="text" class="form-control"
                    ...
                    <div class="col-md-12">
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs pull-right">
                                <li class="active"><a href="#tab_1-1" data-toggle="tab">推荐信息</a></li>
                                <li><a href="#tab_2-2" data-toggle="tab">常用工具</a></li>
                                <li><a href="#tab_3-2" data-toggle="tab">搜索热词</a></li>
                                <li class="pull-left header"><i class="fa fa-th"></i> 我的关注</li>
                            </ul>
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab_1-1">
                                    <div class="box-body table-responsive">
                                        <table id="recommend-search-result-list" class="table table-bordered table-hover">
                                        </table>
                                    </div>
                                </div>
                                <!-- /.tab-pane -->
                                <div class="tab-pane" id="tab_2-2">
                                    <ul class="list-inline" id="common-tool-ul"></ul>
                                </div>
                                <!-- /.tab-pane -->
                                <div class="tab-pane" id="tab_3-2">
                                    <ul class="list-inline" id="hot-search-ul"></ul>
                                </div>
                                <!-- /.tab-pane -->
                            </div>
                            <!-- /.tab-content -->
