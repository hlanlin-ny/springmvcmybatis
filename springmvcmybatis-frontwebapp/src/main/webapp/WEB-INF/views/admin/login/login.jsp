                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        <div class="alert alert-danger alert-dismissible">
                            <h4><i class="icon fa fa-ban"></i>您的浏览器版本太低，请使用如下浏览器</h4>
                            请使用谷歌浏览器（ <strong><a href="{ctxPath}/resources/ChromeStandalone_60.0.3112.101_Setup.exe" target="_blank">点击下载</a></strong> ） 或 360浏览器【极速模式】（ <strong><a href="{ctxPath}/resources/360se_setup.exe" target="_blank">点击下载</a></strong> ）！
                        </div>
                    </div>
                </div>
            </div>
